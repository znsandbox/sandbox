...
namespace ZnSandbox\Sandbox\BlockChain\Domain\Libs\MessageSigner;
...
class MessageSigner
{
    ...
    public function recoverPubKey(SignedMessage $signedMessage, PayToPubKeyHashAddress $address, NetworkInterface $network = null)
    {
        $network = $network ?: Bitcoin::getNetwork();
        $hash = $this->calculateMessageHash($network, $signedMessage->getMessage());
